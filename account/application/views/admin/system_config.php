                ...
                <div class="ibox-content">
                    <form method="get" class="form-horizontal">
                        ...
                        <div class="form-group"><label class="col-sm-2 control-label">Help text</label>
                            <div class="col-sm-5"><input type="text" class="form-control"> <span class="help-block m-b-none">A block of help text that breaks onto a new line and may extend beyond one line.</span>
                            </div>
                        </div>
                        <div class="hr-line-dashed"></div>
                        ...
                        <div class="form-group"><label class="col-sm-2 control-label">Placeholder</label>
                            ...
                            <div class="col-sm-5"><input type="text" placeholder="placeholder" class="form-control"></div>
                        </div>
                        <div class="hr-line-dashed"></div>
                        ...
                        <div class="form-group"><label class="col-sm-2 control-label">Inline checkboxes</label>
                            ...
                            <div class="col-sm-5"><label class="checkbox-inline"> <input type="checkbox" value="option1" id="inlineCheckbox1"> a </label> <label class="checkbox-inline">
                        ...
                        <div class="form-group"><label class="col-sm-2 control-label">Inline checkboxes</label>
                            ...
                            <div class="col-sm-5"><label class="checkbox-inline i-checks"> <input type="checkbox" value="option1">a </label>
                        ...
                        <div class="form-group"><label class="col-sm-2 control-label">Control sizing</label>
                            ...
                            <div class="col-sm-5"><input type="text" placeholder=".input-lg" class="form-control input-lg m-b">
