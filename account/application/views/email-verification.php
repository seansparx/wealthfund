    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-xs-12 text-center">
                <?php
                if (isset($email_verified) && ($email_verified == 'yes')) {
                    echo '<h3>Your account has been activated Successfully..</h3>';
                    echo '<h2 style="color: green;">Email Verified.</h2>';
                } 
                else {
                    echo '<h2 class="mobile-verification">Wrong url / Link has been expired</h2>';
                }
                ?>
                <lable class="redirect-msg"></lable>
            </div>
        </div>
    </div>
