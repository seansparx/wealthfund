    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-xs-12 text-center">
                ...
                <!--<br/>-->                
                Password reset link has been sent to email address you provided, please check your inbox/junk folder.                
                </label>
                <br>
                <br>
                <?php if(!empty($email)){ ?>
                ...
                <div class="text-center"> 
                    <button type="button" class="btn btn-primary  m-b forgettoken resend" id="resubmit_forget_password" name="resubmit_forget_password"  >
                        Resend
                    </button>                
                </div>
                -->
...
$(document).ready(function(){
  ...
  jQuery(".resend").click(function(){      
      if(email != '')
      {
        jQuery.ajax({
        method: "POST",
        url: <?php echo site_url("login/resend_password");?>,
