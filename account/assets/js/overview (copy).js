...
$(function(){
    ...
    /** Life Insurance */
    $(".account-details #life_insurance").click(function() {
    ...
    /** Health Insurance */
    $(".account-details #health_insurance").click(function() {
    ...
    $(".account-details #disable_coverage").click(function() {
    ...
    /** Auto Insurance */
    $(".account-details #auto_insurance").click(function() {
